...
int main(int argc, char *argv[]) {
	...
	if( ai_run ){
		...
		fprintf(fp_output, "Expanded nodes: %'d\n", expanded_nodes);
		fprintf(fp_output, "Generated nodes: %'d\n", generated_nodes);
		fprintf(fp_output, "Solution Length: %d\n", solution_size);
		fprintf(fp_output, "Number of Pegs Left: %d\n", num_pegs( &(solution[solution_size]) ) );
		fprintf(fp_output, "Expanded/seconds: %d\n", (int)(expanded_nodes/cpu_time_used) );
		fprintf(fp_output, "Time (seconds): %f\n", cpu_time_used );
